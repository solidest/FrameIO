    ...
    partial class YH_CAN_Impl
    {
        private void DoAsyncRead(object wr)
        {
            lock (this)
            {
                ...
                FrameBase frameBase = ReadFrame(p.packer);
        ...
        private void DoAsyncReadList(object wr)
        {
            lock (this)
            {
                ...
                do
                {
                    FrameBase[] frameBase = ReadFrameList(p.packer, p.framecount);
        ...
        public void BeginReadFrameListImpl(IFrameUnpack up, int framecount, bool isloop, AsyncReadListCallback callback, object AsyncState)
        {
