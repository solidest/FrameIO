...
public:
	...
	void LoadFioObjextX(void* ovHandle, const char* frmaeName)
	{
		_o = ovHandle;
		_o = FioObjectCreate(frmaeName);
	}
...
public:
	void SetValue(const char* segname, bool* arr, int len)
	{
		FioSetBoolValues(_o, segname, arr, len);
	}

	void SetValue(const char* segname, unsigned char* arr, int len)
	{
		FioSetByteValues(_o, segname, arr, len);
	}

	void SetValue(const char* segname, signed char* arr, int len)
	{
	...
	void SetValue(const char* segname, int* arr, int len)
	{
	...
	void SetValue(const char* segname, long long* arr, int len)
	{
		FioSetLongValues(_o, segname, arr, len);
	}

	void SetValue(const char* segname, unsigned long long* arr, int len)
	{
		FioSetULongValues(_o, segname, arr, len);
	}

	void SetValue(const char* segname, float* arr, int len)
	{
		FioSetFloatValues(_o, segname, arr, len);
	}

	void SetValue(const char* segname, double* arr, int len)
	{
