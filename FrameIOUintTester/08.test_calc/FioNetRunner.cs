    ...
    public static class FioNetRunner
    {
        ...
        static FioNetRunner()
        {
            var config = string.Concat(
                ...
                "nF+aB7LH0AxForIk1b8oBWgQyNjcxJwcFBNd85LzU8BGKgUUZeZmlmSWpaIo",
                "CEvMKQU5yQAmVguXVfJx9RsO3nD1G3KxgeRYoKhzYk5yvGMKSF80sgQsqemg",
                "CYLiDVkoFsGphYcPhAGmgEQtAJjL+o/kAgAA");
