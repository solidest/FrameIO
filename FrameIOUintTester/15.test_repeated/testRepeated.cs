...
{
    public partial class testRepeated
    {

        //属性声明
        public Parameter<uint?> len { get; private set;}
        public ObservableCollection<Parameter<uint?>> end { get; private set; }
        ...
        public void InitialParameter()
        {
            ...
            end = new ObservableCollection<Parameter<uint?>>(); for (int i = 0; i < 2; i++) end.Add(new Parameter<uint?>());
