...
{
    public partial class testtcpmatch
    {

        //属性声明
        public Parameter<short?> len { get; private set;}
        public Parameter<short?> end { get; private set;}
        public Parameter<short?> head { get; private set;}

        //属性初始化
        public void InitialParameter()
        {
            len = new Parameter<short?>();
            end = new Parameter<short?>();
        ...
        public void InitialChannelCHS(ChannelOption ops)
        {
            ...
            if (!ops.Contains("waittimeout")) ops.SetOption("waittimeout", 1000);
