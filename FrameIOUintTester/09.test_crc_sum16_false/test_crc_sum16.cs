...
namespace test_crc_sum16
{
    public partial class test_crc_sum16
    {
        ...
        public Parameter<uint?> A { get; private set;}
        public Parameter<uint?> B { get; private set;}
        ...
        public void InitialParameter()
        {
            ...
            A = new Parameter<uint?>();
            B = new Parameter<uint?>();
        }
