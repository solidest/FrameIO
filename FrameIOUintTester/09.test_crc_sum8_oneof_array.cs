...
namespace FrameIOUintTester
{
    ...
    public class Test_CRC_Sum8_oneof_array
    {
        ...
        {
            //send data 01 00 00 00 01 00 00 00 C8 00 00 00 C8 00 00 00 02 00 00 00 02 00 00 00 02 00 00 00 98 01 00 00
            ...
            Assert.IsTrue(tester_c.one.SegOne.Value == 0x0198);
