    ...
    public partial class test_crc_sum8_oneof_array
    {
        ...
        public void A_Recv()
        {
            ...
            switch((enum_end)__v__.GetValue("SegFlag"))
            {
                ...
                {
                    {
                        var __vv__ = __v__.GetObject("DAT.one");
                        __vv__.GetValue("SegA", one.SegA);
                        __vv__.GetValue("HEAD", one.HEAD);
                        __vv__.GetValue("LEN", one.LEN);
                        __vv__.GetValue("SegOne", one.SegOne);
                    }
                    break;
                }
                case enum_end.two:
                {
                    {
                        var __vv__ = __v__.GetObject("DAT.two");
                        __vv__.GetValue("SegA", two.SegA);
                        __vv__.GetValue("HEAD", two.HEAD);
                        __vv__.GetValue("LEN", two.LEN);
                        __vv__.GetValue("SegTwo", two.SegTwo);
                    }
                    break;
                }
            }
