...
{
    public partial class test_oneof_before
    {
        ...
        public Parameter<short?> a { get; private set;}
        public Parameter<byte?> b { get; private set;}
        public Parameter<byte?> c { get; private set;}
        ...
        public void InitialParameter()
        {
            ...
            a = new Parameter<short?>();
            b = new Parameter<byte?>();
            c = new Parameter<byte?>();
        }
        ...
        //数据发送
        public void A_Send_Type1(Enum_Type Frame_Send_DATATYPE)
        {
            var __v__ = FioNetRunner.NewFrameObject("Frame_Send");
            __v__.SetValue("Sega", a);
            __v__.SetValue("Segb", b);
            __v__.SetValue("Segc", c);
            __v__.SetValue("DATATYPE", datetype);
            switch(Frame_Send_DATATYPE)
            {
                case Enum_Type.enum_type1:
                {
                    __v__.SetValue("DAT.enum_type1.NAME1", name1);
                    __v__.SetValue("DAT.enum_type1.NAME2", name2);
                    break;
                }
                case Enum_Type.enum_type2:
                {
                    __v__.SetValue("DAT.enum_type2.AGE1", age1);
                    __v__.SetValue("DAT.enum_type2.AGE2", age2);
                    break;
                }
            }
        ...
        public void A_Recv()
        {
            ...
            __v__.GetValue("Segb", b);
            __v__.GetValue("Segc", c);
            __v__.GetValue("DATATYPE", datetype);
            switch((Enum_Type)__v__.GetValue("DATATYPE"))
            {
                case Enum_Type.enum_type1:
                {
                ...
                case Enum_Type.enum_type2:
                {
                    __v__.GetValue("DAT.enum_type2.AGE1", age1);
                    __v__.GetValue("DAT.enum_type2.AGE2", age2);
                    break;
                }
            }
        }
