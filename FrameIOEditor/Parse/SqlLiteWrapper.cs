...
namespace SQLiteWrapper
{
    ...
    class SQLiteBase
    {
        ...
        [DllImport("sqlite3")]
        private static extern int sqlite3_bind_text(IntPtr statement, int index, IntPtr paraValue, int len, int flag);
        ...
        /// <summary>
        /// Executes query whith one parameter
        /// </summary>
        /// <param name="query"></param>
        /// <param name="para1">parameter for index 1</param>
        public void ExecuteNonQuery(String query, String para1)
        {
            //UTF8Encoding utf8 = new UTF8Encoding();
            //para1 = utf8.GetString(utf8.GetBytes(para1));
            IntPtr statement;
            IntPtr excessData;
            sqlite3_prepare_v2(database, StringToPointer(query), GetPointerLenght(StringToPointer(query)), out statement, out excessData);
            sqlite3_bind_text(statement, 1, StringToPointer(para1), -1, 0);
